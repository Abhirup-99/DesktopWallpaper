...
def scrape(term=""):
    try:
        ...
        page = randint(1,10)
        if (term != ""):
            url = "https://www.wallpaperflare.com/search?wallpaper={}&page={}".format(term, page)
        else:
            url = "https://www.wallpaperflare.com/index.php?c=main&m=portal_loadmore&page={}".format(page)
        ...
        img_page = imgs[img_random_number].find("a", {"itemprop":"url"})["href"] + "/download/"
